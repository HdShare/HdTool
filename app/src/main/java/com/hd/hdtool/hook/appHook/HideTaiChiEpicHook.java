...
public class HideTaiChiEpicHook {

    public static void hook() {
        if (HdUtils.isDebug()) {
            XposedBridge.log(HdUtils.获取TAG() + " >>start>> " + "swAppSetHideTaiChiEpic");
        }
        try {
            XposedHelpers.findAndHookMethod(
                    ...
                    new XC_MethodHook() {
                        ...
                        protected void afterHookedMethod(MethodHookParam param) throws Throwable {
                            ...
                            if (line != null && line.contains("me.weishu.exp")) {
            ...
            XposedHelpers.findAndHookMethod(
                    ...
                    new XC_MethodHook() {
                        ...
                        protected void afterHookedMethod(MethodHookParam param) throws Throwable {
                            ...
                            if (className != null && className.contains("me.weishu")) {
                                param.setResult("");
                                if (HdUtils.isDebug()) {
